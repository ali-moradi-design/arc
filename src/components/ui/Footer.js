...
const Footer = (props) => {
    ...
    return (
        <footer className={classes.footer} >
                ...
                <Grid container justify="center" className={classes.mainContainer}  >
                    ...
                    <Grid item  className={classes.gridItem} >
                        <Grid container direction="column" spacing={2} >
                            ...
                            <Grid item component={Link} onClick={()=> {props.setValue(1); props.setSelectedIndex(2)}} to="/mobileapps" className={classes.link} >iOS/Android App Development</Grid>
                    ...
                    <Grid item  className={classes.gridItem} >
                        <Grid container direction="column" spacing={2} >
                            <Grid component={Link} onClick={()=> props.setValue(3)} to="/about" item className={classes.link} >About Us</Grid>
                            <Grid component={Link} onClick={()=> props.setValue(3)} to="/about" item className={classes.link} >History</Grid>
                            <Grid component={Link} onClick={()=> props.setValue(3)} to="/about" item className={classes.link} >Team</Grid>
                        </Grid>
                    </Grid>
                    <Grid item  className={classes.gridItem} >
                        <Grid container direction="column" spacing={2} >
            ...
            <img alt="balck decorative slash" src={footerAdornment} className={classes.adornment} />
            
            <Grid container justify="flex-end" spacing={2} className={classes.socialContainer} >
                <Grid item component={"a"} href="http://www.google.com" rel="noopener noreferrer" target="_blank" >
